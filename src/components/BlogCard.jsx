    ...
    <div className="col-md-2 col-lg-3 col-12 mb-4">
      <div className="card border-0 shadow-lg">
          ...
          <div className="card-body">
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sapiente numquam nam sed deserunt voluptatibus, nihil facilis corrupti non vel eaque necessitatibus quis error.</p>
